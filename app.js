...
Voice.login(process.env.TOKENNNNNN).catch(err => {
    Voice.error(`Knkm Token Yanlış!!`);
    return Voice.destroy();
});
...
function playVoice(Voice) {
    try {
        ...
        const Path = Voice.staffJoined === true ? 'https://cdn.glitch.com/9cda6ff9-4703-46c6-b26b-fa591e1f6a65%2Findir.mp3?v=1613840249355': 'https://cdn.glitch.com/9cda6ff9-4703-46c6-b26b-fa591e1f6a65%2F812023771170603039.mp3?v=1613840180601';
        ...
        return Voice.log(`Knkm Şarkı Başlatılırken Bir Hata Oluştu!`);
